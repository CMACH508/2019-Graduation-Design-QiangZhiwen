...
# ---------------------------------- two----------------------------------------------
    ...
    s_down0b = concatenate([up0b, s_down0b], axis=3)
    ...
    s_down0 = concatenate([up0, s_down0], axis=3)
    ...
    s_down1 = concatenate([up1, s_down1], axis=3)
    ...
    s_down2 = concatenate([up2, s_down2], axis=3)
    ...
    s_down3 = concatenate([up3, s_down3], axis=3)
    ...
    s_down4 = concatenate([up4, s_down4], axis=3)
...
# ---------------------------------- three----------------------------------------------
    ...
    down0b = Conv2D(8, (3, 3), padding='same')(s_up0b)

    down0b = concatenate([s_up0b, down0b], axis=3)
    ...
    down0a = Conv2D(16, (3, 3), padding='same')(down0b_pool)
    down0a = concatenate([s_up0a, down0a], axis=3)
    ...
    down0 = Conv2D(32, (3, 3), padding='same')(down0a_pool)
    down0 = concatenate([s_up0, down0], axis=3)
    ...
    down1 = Conv2D(64, (3, 3), padding='same')(down0_pool)
    down1 = concatenate([s_up1, down1], axis=3)
    ...
    down2 = Conv2D(128, (3, 3), padding='same')(down1_pool)
    down2 = concatenate([s_up2, down2], axis=3)
    ...
    down3 = Conv2D(256, (3, 3), padding='same')(down2_pool)
    down3 = concatenate([s_up3, down3], axis=3)
    ...
    down4 = Conv2D(512, (3, 3), padding='same')(down3_pool)
    down4 = concatenate([s_up4, down4], axis=3)
...
# ---------------------------------- three----------------------------------------------
    ...
    model.compile('Adam', loss=bce_dice_loss, metrics=[iou_score])
